...
/**
 * Tracks the background sync of CRM data for a single organization/provider pair.
 * Scope is intentionally limited to contacts + deals (with deal-stage history),
 * which is all the data the dashboard's stats and pipeline graph need.
 */
